...
pub const SERVER_PACKAGE: &str = "animation-core-server";
...
pub fn package_surface() -> PackageSurface {
    animation_core::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = animation_core::surface::run_surface_operation(SurfaceRequest {
