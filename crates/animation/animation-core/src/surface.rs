//! Library-owned runtime surface for `animation-core`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Shared timeline, keyframe, track, clip, and skeleton contracts for animation workflows.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize timeline",
                "Summarizes animation clip timing, track counts, keyframe counts, and interpolation modes.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Sample keyframes",
                "Builds a deterministic keyframe sampling plan for scalar, vector, and transform tracks.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Preview easing",
                "Returns a deterministic easing preview plan for step, linear, and cubic interpolation modes.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
