    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "SVG projection and preview helpers for lightweight 3D scene inspection.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize scene SVG",
                "Summarizes projected 3D scene nodes, camera framing, labels, and SVG element counts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan scene render",
                "Builds a deterministic SVG render plan for points, meshes, axes, and camera previews.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Export SVG",
                "Returns a deterministic export description for a standalone SVG scene preview.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
