...
pub const SERVER_PACKAGE: &str = "three-d-processing-core-server";
...
pub fn package_surface() -> PackageSurface {
    three_d_processing_core::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = three_d_processing_core::surface::run_surface_operation(SurfaceRequest {
