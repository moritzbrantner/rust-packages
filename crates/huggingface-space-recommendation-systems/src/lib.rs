//! Hugging Face Space category metadata for Recommendation Systems.
//!
//! Source category list: <https://huggingface.co/spaces>

/// Human-readable Hugging Face Space category name.
pub const NAME: &str = "Recommendation Systems";

/// Stable kebab-case identifier used by this crate.
pub const SLUG: &str = "recommendation-systems";
...
pub const SEARCH_QUERY: &str = "Recommendation Systems";
