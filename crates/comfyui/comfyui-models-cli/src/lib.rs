...
pub const SERVER_PACKAGE: &str = "comfyui-models-server";
...
pub fn package_surface() -> PackageSurface {
    comfyui_models::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = comfyui_models::surface::run_surface_operation(SurfaceRequest {
