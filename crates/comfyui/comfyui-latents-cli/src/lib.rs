...
pub const SERVER_PACKAGE: &str = "comfyui-latents-server";
...
pub fn package_surface() -> PackageSurface {
    comfyui_latents::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = comfyui_latents::surface::run_surface_operation(SurfaceRequest {
