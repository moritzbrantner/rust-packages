...
pub const SERVER_PACKAGE: &str = "runtime-artifacts-server";
...
pub fn package_surface() -> PackageSurface {
    runtime_artifacts::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = runtime_artifacts::surface::run_surface_operation(SurfaceRequest {
