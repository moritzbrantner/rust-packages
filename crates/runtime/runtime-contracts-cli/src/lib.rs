...
pub const LIBRARY_IMPORT: &str = "use runtime_contracts";
/// Companion server package name.
pub const SERVER_PACKAGE: &str = "runtime-contracts-server";
/// Companion React app package name.
pub const APP_PACKAGE: &str = "runtime-contracts-app";
