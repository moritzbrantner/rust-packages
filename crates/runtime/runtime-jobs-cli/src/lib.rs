...
pub const SERVER_PACKAGE: &str = "runtime-jobs-server";
...
pub fn package_surface() -> PackageSurface {
    runtime_jobs::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = runtime_jobs::surface::run_surface_operation(SurfaceRequest {
