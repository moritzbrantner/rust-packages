...
pub const SERVER_PACKAGE: &str = "video-analysis-ingest-server";
...
pub fn package_surface() -> PackageSurface {
    video_analysis_ingest::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = video_analysis_ingest::surface::run_surface_operation(SurfaceRequest {
