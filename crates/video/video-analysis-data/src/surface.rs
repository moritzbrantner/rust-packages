//! Library-owned runtime surface for `video-analysis-data`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Data interchange records for retained video-analysis results.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize records",
                "Summarizes retained dataset records by kind, stream, scene, and timestamp coverage.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Builds a deterministic event timeline from scenes, cuts, observations, and analysis events.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                "video.data.joinPlan",
                "Plan data join",
                "Describes deterministic joins across records, metrics, features, tracks, and scenes.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
