//! Library-owned runtime surface for `video-analysis-gaussian-splatting`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Gaussian splatting data contracts and planning helpers for video-derived radiance assets.",
                serde_json::json!({
            ...
            operation(
                "video.splat.summary",
                "Summarize splats",
                "Summarizes Gaussian splat counts, bounds, color ranges, and opacity statistics.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan splat cameras",
                "Builds a deterministic camera sampling plan for Gaussian splat inspection.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan splat training",
                "Describes dataset, camera, and artifact requirements for Gaussian splat training.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
