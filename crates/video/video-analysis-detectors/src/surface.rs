    ...
    PackageSurface {
        ...
        operations: vec![
            ...
            operation(
                ...
                "Summarizes detector names, supported observations, and deterministic configuration defaults.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                "video.detectors.colorRule",
                "Plan color rule detector",
                "Builds a deterministic color-rule detector plan for frame regions and score thresholds.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                "video.detectors.boxSummary",
                "Summarize boxes",
                "Summarizes detection boxes, labels, scores, and region coverage.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
