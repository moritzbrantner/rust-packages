...
pub const SERVER_PACKAGE: &str = "video-analysis-reconstruction-server";
...
pub fn package_surface() -> PackageSurface {
    video_analysis_reconstruction::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    video_analysis_reconstruction::surface::run_surface_operation(SurfaceRequest {
