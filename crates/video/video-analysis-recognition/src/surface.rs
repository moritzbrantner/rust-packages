    ...
    PackageSurface {
        ...
        operations: vec![
            ...
            operation(
                ...
                "Plan labels",
                "Builds a deterministic label taxonomy and normalization plan for recognition outputs.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarizes recognized labels over tracks, scenes, and time windows.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarizes confidence ranges, thresholds, and accepted/rejected recognition counts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
