//! Library-owned runtime surface for `video-analysis-radiance-pipeline`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Pipeline contracts for COLMAP, radiance training, and render artifact orchestration.",
                serde_json::json!({
            ...
            operation(
                ...
                "Plan radiance stages",
                "Builds a deterministic staged pipeline for image extraction, COLMAP, training, and rendering.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Check radiance assets",
                "Summarizes required and produced assets for a radiance reconstruction run.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan radiance commands",
                "Describes command invocations without running external radiance tools.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
