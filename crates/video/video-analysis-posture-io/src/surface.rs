//! Library-owned runtime surface for `video-analysis-posture-io`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Pose and posture import/export helpers for common interchange formats.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize posture format",
                "Summarizes posture input formats, coordinate systems, and keypoint naming.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan posture parse",
                "Builds a deterministic parse plan for pose and keypoint files.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan posture export",
                "Builds a deterministic export plan for pose, skeleton, and motion data.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
