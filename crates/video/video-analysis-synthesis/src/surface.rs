    ...
    PackageSurface {
        ...
        operations: vec![
            ...
            operation(
                ...
                "Builds a deterministic frame generation plan with timing, dimensions, and colors.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan overlays",
                "Describes deterministic text, box, mask, and pose overlays for rendered frames.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarize render",
                "Summarizes render settings, frame counts, duration, and expected artifacts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
