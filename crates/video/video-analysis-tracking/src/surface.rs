    ...
    PackageSurface {
        ...
        operations: vec![
            ...
            operation(
                ...
                "Summarize tracks",
                "Summarizes track identities, labels, frame ranges, and hit counts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan assignments",
                "Builds a deterministic association plan for observations across frames.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Smooth track path",
                "Describes deterministic path smoothing inputs, windows, and output samples.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
