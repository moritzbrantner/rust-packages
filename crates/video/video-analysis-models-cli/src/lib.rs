...
pub const SERVER_PACKAGE: &str = "video-analysis-models-server";
...
pub fn package_surface() -> PackageSurface {
    video_analysis_models::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    video_analysis_models::surface::run_surface_operation(SurfaceRequest {
