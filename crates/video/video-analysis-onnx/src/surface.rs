//! Library-owned runtime surface for `video-analysis-onnx`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "ONNX model planning and decode helpers for video-analysis.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize ONNX model",
                "Summarizes model inputs, outputs, labels, and expected tensor layouts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan ONNX inputs",
                "Builds a deterministic preprocessing and tensor input plan for video frames.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Decode detections",
                "Decodes detection tensor metadata into deterministic boxes, labels, and score summaries.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
