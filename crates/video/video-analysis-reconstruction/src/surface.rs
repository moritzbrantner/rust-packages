//! Library-owned runtime surface for `video-analysis-reconstruction`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "3D reconstruction planning contracts spanning sparse, dense, and radiance outputs.",
                serde_json::json!({
            ...
            operation(
                ...
                "Plan reconstruction",
                "Builds a deterministic reconstruction plan from frames, cameras, and backend selections.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarize cameras",
                "Summarizes reconstruction camera intrinsics, poses, and frame coverage.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarize assets",
                "Summarizes sparse, dense, mesh, and radiance reconstruction artifacts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
