//! Library-owned runtime surface for `video-analysis-posture`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Pose, posture, keypoint, and skeleton contracts for video-analysis.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize keypoints",
                "Summarizes 2D and 3D keypoints, visibility, scores, and bounds.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan skeleton",
                "Builds a deterministic skeleton connection and rendering plan.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarize motion",
                "Summarizes keypoint tracks, displacement, and per-joint motion coverage.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
