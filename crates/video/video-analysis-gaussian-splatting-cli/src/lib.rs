...
pub const SERVER_PACKAGE: &str = "video-analysis-gaussian-splatting-server";
...
pub fn package_surface() -> PackageSurface {
    video_analysis_gaussian_splatting::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    video_analysis_gaussian_splatting::surface::run_surface_operation(SurfaceRequest {
