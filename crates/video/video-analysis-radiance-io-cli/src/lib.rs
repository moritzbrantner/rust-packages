...
pub const SERVER_PACKAGE: &str = "video-analysis-radiance-io-server";
...
pub fn package_surface() -> PackageSurface {
    video_analysis_radiance_io::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    video_analysis_radiance_io::surface::run_surface_operation(SurfaceRequest {
