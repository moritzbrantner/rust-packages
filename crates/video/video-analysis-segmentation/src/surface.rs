    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Segmentation mask contracts and prompt planning for video-analysis.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize masks",
                "Summarizes mask dimensions, labels, coverage, and confidence ranges.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan segmentation prompt",
                "Builds a deterministic prompt plan from boxes, points, labels, and frames.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan mask tracking",
                "Describes mask propagation and track association across frames.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
