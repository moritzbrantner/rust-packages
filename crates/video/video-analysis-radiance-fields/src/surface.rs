//! Library-owned runtime surface for `video-analysis-radiance-fields`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Radiance field contracts for camera paths, training assets, and rendered outputs.",
                serde_json::json!({
            ...
            operation(
                ...
                "Summarize radiance field",
                "Summarizes radiance field metadata, scene bounds, cameras, and artifact coverage.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan camera path",
                "Builds a deterministic camera path from scene bounds and keyframes.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan radiance render",
                "Builds a deterministic render plan for viewpoints, resolution, and outputs.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            Some(runtime_core::landscape::LandscapeOperationContract::new(
                ...
                .input(
                    runtime_core::landscape::LandscapePort::new(
                        "cameras",
                        runtime_core::landscape::well_known::video_camera(),
                    )
                    .many(),
                )
                .output(runtime_core::landscape::LandscapePort::new(
                    "path",
                    runtime_core::landscape::well_known::video_camera_path(),
                ))
