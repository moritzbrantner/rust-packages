...
pub const SERVER_PACKAGE: &str = "video-analysis-posture-server";
...
pub fn package_surface() -> PackageSurface {
    video_analysis_posture::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = video_analysis_posture::surface::run_surface_operation(SurfaceRequest {
