//! Library-owned runtime surface for `video-analysis-mvs`.
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "Multi-view stereo planning and dense reconstruction contracts.",
                serde_json::json!({
            ...
            operation(
                "video.mvs.depthPlan",
                "Plan depth maps",
                "Builds a deterministic depth-map estimation plan from camera and image metadata.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Plan fusion",
                "Describes dense point fusion inputs, filtering thresholds, and output artifacts.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
            ...
            operation(
                ...
                "Summarize MVS output",
                "Summarizes dense reconstruction points, bounds, normals, and confidence ranges.",
                serde_json::json!({
                    "input": {},
                    "mode": "deterministic"
                }),
