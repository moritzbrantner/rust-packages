...
For the high-level workflow across contracts, `TextCorpus`, retrieval, analysis,
classification, and cited QA, see
[`docs/TEXT_WORKSPACE_GUIDE.md`](../../../docs/TEXT_WORKSPACE_GUIDE.md). For
the lower-level corpus APIs, see
