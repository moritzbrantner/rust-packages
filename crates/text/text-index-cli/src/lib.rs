...
pub const LIBRARY_CRATE: &str = "text-index";
pub const SURFACE_KIND: &str = "cli";
pub const LIBRARY_IMPORT: &str = "use text_index";
pub const SERVER_PACKAGE: &str = "text-index-server";
pub const APP_PACKAGE: &str = "text-index-app";
pub const WASM_PACKAGE: &str = "text-index-wasm";
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    cli::run_wrapped_operation(operation, input, text_index::surface::run_surface_operation)
}
