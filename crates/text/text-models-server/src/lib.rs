...
use text_models as _;

/// Wrapped library crate name.
pub const LIBRARY_CRATE: &str = "text-models";
/// Adapter surface kind.
pub const SURFACE_KIND: &str = "api";
/// Rust import path for the wrapped crate.
pub const LIBRARY_IMPORT: &str = "use text_models";
/// Companion CLI package name.
pub const CLI_PACKAGE: &str = "text-models-cli";
/// Companion React app package name.
pub const APP_PACKAGE: &str = "text-models-app";
