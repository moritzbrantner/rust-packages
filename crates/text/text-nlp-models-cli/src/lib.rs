...
pub const SERVER_PACKAGE: &str = "text-nlp-models-server";
...
pub fn package_surface() -> PackageSurface {
    text_nlp_models::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    text_nlp_models::surface::run_surface_operation(SurfaceRequest {
