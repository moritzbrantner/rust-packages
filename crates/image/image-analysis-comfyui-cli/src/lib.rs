...
pub const SERVER_PACKAGE: &str = "image-analysis-comfyui-server";
...
pub fn package_surface() -> PackageSurface {
    image_analysis_comfyui::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = image_analysis_comfyui::surface::run_surface_operation(SurfaceRequest {
