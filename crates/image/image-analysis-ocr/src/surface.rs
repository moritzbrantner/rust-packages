...
use crate::{
    OcrBlockKind, OcrConfidence, OcrDocument, OcrPreset, OcrRequest, OcrTechnique, OcrTextBlock,
    OcrTextLine, OcrToken,
};
    ...
    PackageSurface {
        ...
        operations: vec![
            operation(
                "describe",
                "Describe package",
                "OCR model presets, request contracts, and imported OCR document summaries.",
