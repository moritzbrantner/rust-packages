...
pub const SERVER_PACKAGE: &str = "image-analysis-tasks-server";
...
pub fn package_surface() -> PackageSurface {
    image_analysis_tasks::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    image_analysis_tasks::surface::run_surface_operation(SurfaceRequest {
