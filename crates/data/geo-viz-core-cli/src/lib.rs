...
pub const SERVER_PACKAGE: &str = "geo-viz-core-server";
...
pub fn package_surface() -> PackageSurface {
    geo_viz_core::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = geo_viz_core::surface::run_surface_operation(SurfaceRequest {
