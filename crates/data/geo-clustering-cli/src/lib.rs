...
pub const SERVER_PACKAGE: &str = "geo-clustering-server";
...
pub fn package_surface() -> PackageSurface {
    geo_clustering::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = geo_clustering::surface::run_surface_operation(SurfaceRequest {
