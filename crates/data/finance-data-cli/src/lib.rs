...
pub const LIBRARY_CRATE: &str = "finance-data";
/// Adapter surface kind.
pub const SURFACE_KIND: &str = "cli";
/// Rust import path for the wrapped crate.
pub const LIBRARY_IMPORT: &str = "use finance_data";
/// Companion server package name.
pub const SERVER_PACKAGE: &str = "finance-data-server";
/// Companion React app package name.
pub const APP_PACKAGE: &str = "finance-data-app";
/// Companion WASM package name.
pub const WASM_PACKAGE: &str = "finance-data-wasm";
