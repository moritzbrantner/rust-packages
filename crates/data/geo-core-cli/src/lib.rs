...
pub const SERVER_PACKAGE: &str = "geo-core-server";
...
pub fn package_surface() -> PackageSurface {
    geo_core::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    cli::run_wrapped_operation(operation, input, geo_core::surface::run_surface_operation)
}
