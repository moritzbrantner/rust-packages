...
pub const SERVER_PACKAGE: &str = "audio-analysis-pitch-server";
...
pub fn package_surface() -> PackageSurface {
    audio_analysis_pitch::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = audio_analysis_pitch::surface::run_surface_operation(SurfaceRequest {
