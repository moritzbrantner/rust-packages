...
pub const SERVER_PACKAGE: &str = "audio-analysis-test-support-server";
...
pub fn package_surface() -> PackageSurface {
    audio_analysis_test_support::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    audio_analysis_test_support::surface::run_surface_operation(SurfaceRequest {
