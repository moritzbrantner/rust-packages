...
pub const SERVER_PACKAGE: &str = "audio-analysis-tasks-server";
...
pub fn package_surface() -> PackageSurface {
    audio_analysis_tasks::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    audio_analysis_tasks::surface::run_surface_operation(SurfaceRequest {
