...
pub const LIBRARY_CRATE: &str = "audio-generation-tts";
/// Adapter surface kind.
pub const SURFACE_KIND: &str = "cli";
/// Rust import path for the wrapped crate.
pub const LIBRARY_IMPORT: &str = "use audio_generation_tts";
/// Companion server package name.
pub const SERVER_PACKAGE: &str = "audio-generation-tts-server";
/// Companion React app package name.
pub const APP_PACKAGE: &str = "audio-generation-tts-app";
/// Companion WASM package name.
pub const WASM_PACKAGE: &str = "audio-generation-tts-wasm";
...
pub fn package_surface() -> PackageSurface {
    audio_generation_tts::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    cli::run_wrapped_operation(
        operation,
        input,
        audio_generation_tts::surface::run_surface_operation,
    )
}
