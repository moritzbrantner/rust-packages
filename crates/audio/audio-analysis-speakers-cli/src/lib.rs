...
pub const SERVER_PACKAGE: &str = "audio-analysis-speakers-server";
...
pub fn package_surface() -> PackageSurface {
    audio_analysis_speakers::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = audio_analysis_speakers::surface::run_surface_operation(SurfaceRequest {
