...
pub const SERVER_PACKAGE: &str = "audio-generation-midi-server";
...
pub fn package_surface() -> PackageSurface {
    audio_generation_midi::surface::package_surface()
}
...
pub fn run_operation(operation: &str, input: serde_json::Value) -> Result<SurfaceResponse, String> {
    let mut response = audio_generation_midi::surface::run_surface_operation(SurfaceRequest {
