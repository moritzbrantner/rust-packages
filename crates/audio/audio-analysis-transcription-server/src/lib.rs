...
pub const LIBRARY_CRATE: &str = "audio-analysis-transcription";
/// Adapter surface kind.
pub const SURFACE_KIND: &str = "api";
/// Rust import path for the wrapped crate.
pub const LIBRARY_IMPORT: &str = "use audio_analysis_transcription";
/// Companion CLI package name.
pub const CLI_PACKAGE: &str = "audio-analysis-transcription-cli";
/// Companion React app package name.
pub const APP_PACKAGE: &str = "audio-analysis-transcription-app";
/// Companion WASM package name.
pub const WASM_PACKAGE: &str = "audio-analysis-transcription-wasm";
...
pub fn serve(addr: &str) -> io::Result<()> {
    server::serve(
        ...
        METADATA,
        package_surface,
        audio_analysis_transcription::surface::run_surface_operation,
    )
}
