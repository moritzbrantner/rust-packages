...
CHECKS: tuple[Check, ...] = (
    ...
    Check(
        ...
        ("moritzbrantner-audio-analysis-transcription",),
        "native whisper.cpp audio transcription compatibility adapter",
        "bash scripts/setup_whisper_cpp_external_model.sh",
        "RUN_NATIVE_WHISPER_TESTS=1 cargo test -p moenarch-audio-analysis-transcription --features native,external-tests --test whisper_native_external native_whisper_cpp_smoke_when_requested -- --ignored --nocapture",
        ...
        expected_tests=("native_whisper_cpp_smoke_when_requested",),
    ),
    Check(
