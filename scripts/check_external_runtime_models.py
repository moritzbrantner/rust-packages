...
CHECKS: tuple[Check, ...] = (
    ...
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh all bundles",
        "cargo test -p moritzbrantner-text-model-runtime --features external-tests -- --ignored --nocapture",
        required_env=("ORT_DYLIB_PATH",),
        required_paths=("ORT_DYLIB_PATH",),
    ...
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh all bundles",
        "cargo test -p moritzbrantner-text-embeddings --features external-tests -- --ignored --nocapture",
        required_env=("ORT_DYLIB_PATH",),
        required_paths=("ORT_DYLIB_PATH",),
    ),
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh all bundles",
        "cargo test -p moritzbrantner-text-linguistics --features external-tests -- --ignored --nocapture",
    ),
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh all bundles",
        "cargo test -p moritzbrantner-text-classification --features external-tests --test local_models_external distilbert_sst2 -- --ignored --nocapture",
    ...
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh all bundles",
        "cargo test -p moritzbrantner-text-classification --features external-tests --test local_models_external bart_mnli_zero_shot_smoke -- --ignored --nocapture",
        required_env=("ORT_DYLIB_PATH",),
    ...
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh onnx bundles",
        "cargo test -p moritzbrantner-text-question-answering --features external-tests -- --ignored --nocapture",
        required_env=("ORT_DYLIB_PATH",),
        required_paths=("ORT_DYLIB_PATH",),
    ),
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh all bundles",
        "cargo test -p moritzbrantner-text-analysis --features external-tests -- --ignored --nocapture",
        required_env=("ORT_DYLIB_PATH",),
        required_paths=("ORT_DYLIB_PATH",),
    ),
    Check(
        ...
        "FFMPEG_EXTERNAL_TESTS=1 cargo test -p moritzbrantner-audio-analysis-io --test ffmpeg_decode -- --nocapture",
    ...
    Check(
        ...
        "RUN_REAL_DEMUCS_TESTS=1 cargo test -p moritzbrantner-audio-analysis-separation --features external-tests real_demucs_smoke_test_when_requested -- --ignored --nocapture",
    ...
    Check(
        ...
        "bash scripts/setup_e2e_external_tools.sh ffmpeg",
        "cargo test -p moritzbrantner-video-analysis-ffmpeg --features ffmpeg-tests --lib -- --nocapture",
        required_commands=("ffmpeg", "ffprobe"),
        expected_tests=(
    ...
    Check(
        ...
        "bash scripts/setup_e2e_external_tools.sh ffmpeg",
        "cargo test -p moritzbrantner-video-analysis-split --features external-tests --test ffmpeg_split -- --ignored --nocapture",
        required_commands=("ffmpeg", "ffprobe"),
    ),
    Check(
        "video-cli-external",
        ...
        "bash scripts/setup_e2e_external_tools.sh ffmpeg",
        "cargo test -p moritzbrantner-video-analysis-cli --test cli_smoke vanalyze_detect_writes_scene_csv_for_generated_video -- --ignored --nocapture",
        required_commands=("ffmpeg", "ffprobe"),
    ),
    Check(
        ...
        "RUN_NATIVE_TRANSCRIPTION_TESTS=1 cargo test -p moritzbrantner-audio-analysis-transcription --features candle,cuda,model-bundles candle_whisper_cuda_smoke_when_requested -- --ignored --nocapture",
        tags=("gpu",),
    ...
    Check(
        ...
        "cargo test -p moritzbrantner-audio-analysis-transcription --features candle,alignment,model-bundles ctc_alignment_wav2vec2_smoke_when_requested -- --ignored --nocapture",
    ...
    Check(
        ...
        "bash scripts/setup_e2e_external_tools.sh ffmpeg",
        "RUN_NATIVE_MEDIA_DECODE_TESTS=1 cargo test -p moritzbrantner-audio-analysis-transcription --features audio-io native_media_decode_when_requested -- --ignored --nocapture",
    ...
    Check(
        ...
        "RUN_NATIVE_DIARIZATION_TESTS=1 cargo test -p moritzbrantner-audio-analysis-speakers --features external-tests native_diarization_baseline_smoke_when_requested -- --ignored --nocapture",
    ...
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh onnx bundles",
        "RUN_NATIVE_SPEAKER_MODEL_TESTS=1 cargo test -p moritzbrantner-audio-analysis-speakers --features onnx,model-bundles onnx_speaker_embedding_smoke_when_requested -- --ignored --nocapture",
        required_env=(
            "ORT_DYLIB_PATH",
    ...
    Check(
        ...
        "bash scripts/setup_model_external_tools.sh onnx bundles",
        "RUN_NATIVE_SPEAKER_MODEL_TESTS=1 cargo test -p moritzbrantner-audio-analysis-transcription --features diarization,onnx,model-bundles native_onnx_diarization_smoke_when_requested -- --ignored --nocapture",
        required_env=(
            "ORT_DYLIB_PATH",
            "SPEAKER_EMBEDDING_MODEL_BUNDLE",
            "DIARIZATION_AUDIO_PATH",
    ...
    Check(
        ...
        "bash scripts/setup_e2e_external_tools.sh all",
        "cargo test -p moritzbrantner-video-analysis-use-cases --test external_tools -- --ignored --nocapture --skip image_person_edit_workflow_runs_with_real_tools_when_configured",
