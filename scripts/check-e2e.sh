...
RUN_NATIVE_WHISPER_TESTS=1 cargo test --jobs "$CARGO_BUILD_JOBS" -p moenarch-audio-analysis-transcription --features native,external-tests --test whisper_native_external native_whisper_cpp_smoke_when_requested -- --ignored --nocapture
