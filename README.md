...
- `finance-statistics`: return-series generation, rolling statistics,
...
- `audio-analysis-speakers`: speaker-domain embeddings, enrollment,
...
- `text-analysis`: orchestration reports that combine core document analysis,
...
- `three-d-scene-svg`: SVG-inspired Scene Vector 3D documents, validation,
...
[Text Release Scope](docs/TEXT_RELEASE_SCOPE.md).
