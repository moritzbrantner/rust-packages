import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-detection-wasm";
...
export const wrappedLibrary = "image-analysis-detection";
