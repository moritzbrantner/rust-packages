import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-storage-wasm";
...
export const wrappedLibrary = "video-analysis-storage";
