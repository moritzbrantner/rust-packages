import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-synthesis-wasm";
...
export const wrappedLibrary = "image-analysis-synthesis";
