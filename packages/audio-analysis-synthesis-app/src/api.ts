import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-synthesis-wasm";
...
export const wrappedLibrary = "audio-analysis-synthesis";
