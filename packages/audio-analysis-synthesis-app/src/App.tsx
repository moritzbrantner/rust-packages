...
const packageDescription = "Deterministic audio synthesis from analysis events for video-analysis.";
      ...
      <section className="border-b border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-semibold">Audio Analysis Synthesis</h1>
        ...
        <form className="panel" onSubmit={submit}>
          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="section-copy">POST payload for audio-analysis-synthesis-server.</p>
            </div>
