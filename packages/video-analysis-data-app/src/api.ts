import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-data-wasm";
...
export const wrappedLibrary = "video-analysis-data";
