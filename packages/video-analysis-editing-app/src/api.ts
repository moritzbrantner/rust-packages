import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-editing-wasm";
...
export const wrappedLibrary = "video-analysis-editing";
