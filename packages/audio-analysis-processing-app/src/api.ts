import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-processing-wasm";
...
export const wrappedLibrary = "audio-analysis-processing";
