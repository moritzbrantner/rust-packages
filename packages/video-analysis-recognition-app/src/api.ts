import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-recognition-wasm";
...
export const wrappedLibrary = "video-analysis-recognition";
