import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/text-question-answering-wasm";
...
export const wrappedLibrary = "text-question-answering";
