import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-detectors-wasm";
...
export const wrappedLibrary = "video-analysis-detectors";
