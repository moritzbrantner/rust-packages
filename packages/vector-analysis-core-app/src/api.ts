import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/vector-analysis-core-wasm";
...
export const wrappedLibrary = "vector-analysis-core";
