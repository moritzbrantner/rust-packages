import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-speakers-wasm";
...
export const wrappedLibrary = "audio-analysis-speakers";
