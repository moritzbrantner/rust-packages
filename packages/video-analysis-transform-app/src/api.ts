import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-transform-wasm";
...
export const wrappedLibrary = "video-analysis-transform";
