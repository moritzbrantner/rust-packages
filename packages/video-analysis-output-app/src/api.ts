import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-output-wasm";
...
export const wrappedLibrary = "video-analysis-output";
