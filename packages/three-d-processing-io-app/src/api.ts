import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/three-d-processing-io-wasm";
...
export const wrappedLibrary = "three-d-processing-io";
