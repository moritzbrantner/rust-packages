import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-fourier-wasm";
...
export const wrappedLibrary = "audio-analysis-fourier";
