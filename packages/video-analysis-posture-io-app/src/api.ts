import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-posture-io-wasm";
...
export const wrappedLibrary = "video-analysis-posture-io";
