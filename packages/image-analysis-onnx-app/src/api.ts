import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-onnx-wasm";
...
export const wrappedLibrary = "image-analysis-onnx";
