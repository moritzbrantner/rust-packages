import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-core-wasm";
...
export const wrappedLibrary = "image-analysis-core";
