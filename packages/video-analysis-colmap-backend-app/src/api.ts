import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-colmap-backend-wasm";
...
export const wrappedLibrary = "video-analysis-colmap-backend";
