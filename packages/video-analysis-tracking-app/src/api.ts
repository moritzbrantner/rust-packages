import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-tracking-wasm";
...
export const wrappedLibrary = "video-analysis-tracking";
