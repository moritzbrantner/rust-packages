import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-gaussian-splatting-wasm";
...
export const wrappedLibrary = "video-analysis-gaussian-splatting";
