import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-ffmpeg-wasm";
...
export const wrappedLibrary = "video-analysis-ffmpeg";
