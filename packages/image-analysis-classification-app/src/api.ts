import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-classification-wasm";
...
export const wrappedLibrary = "image-analysis-classification";
