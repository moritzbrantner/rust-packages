import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-separation-wasm";
...
export const wrappedLibrary = "audio-analysis-separation";
