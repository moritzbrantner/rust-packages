import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-processing-wasm";
...
export const wrappedLibrary = "image-analysis-processing";
