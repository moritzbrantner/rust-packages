import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-posture-wasm";
...
export const wrappedLibrary = "video-analysis-posture";
