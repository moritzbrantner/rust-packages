import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-test-support-wasm";
...
export const wrappedLibrary = "video-analysis-test-support";
