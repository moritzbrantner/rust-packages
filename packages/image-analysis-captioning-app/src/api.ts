import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-captioning-wasm";
...
export const wrappedLibrary = "image-analysis-captioning";
