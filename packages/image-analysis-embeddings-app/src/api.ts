import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/image-analysis-embeddings-wasm";
...
export const wrappedLibrary = "image-analysis-embeddings";
