import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-core-wasm";
...
export const wrappedLibrary = "audio-analysis-core";
