import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-sfm-rust-backend-wasm";
...
export const wrappedLibrary = "video-analysis-sfm-rust-backend";
