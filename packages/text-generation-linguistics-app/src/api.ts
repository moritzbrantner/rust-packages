import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/text-generation-linguistics-wasm";
...
export const wrappedLibrary = "text-generation-linguistics";
