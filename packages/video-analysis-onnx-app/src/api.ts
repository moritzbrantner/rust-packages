import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-onnx-wasm";
...
export const wrappedLibrary = "video-analysis-onnx";
