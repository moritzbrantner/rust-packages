import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-split-wasm";
...
export const wrappedLibrary = "video-analysis-split";
