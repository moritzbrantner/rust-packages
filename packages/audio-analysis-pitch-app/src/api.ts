import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/audio-analysis-pitch-wasm";
...
export const wrappedLibrary = "audio-analysis-pitch";
