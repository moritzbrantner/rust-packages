import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-opencv-backend-wasm";
...
export const wrappedLibrary = "video-analysis-opencv-backend";
