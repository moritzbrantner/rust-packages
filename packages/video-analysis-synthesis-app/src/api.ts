import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-synthesis-wasm";
...
export const wrappedLibrary = "video-analysis-synthesis";
