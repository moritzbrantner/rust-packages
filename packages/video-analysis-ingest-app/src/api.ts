import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-ingest-wasm";
...
export const wrappedLibrary = "video-analysis-ingest";
