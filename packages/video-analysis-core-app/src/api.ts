import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-core-wasm";
...
export const wrappedLibrary = "video-analysis-core";
