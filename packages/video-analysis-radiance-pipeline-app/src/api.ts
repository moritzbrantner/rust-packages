import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-radiance-pipeline-wasm";
...
export const wrappedLibrary = "video-analysis-radiance-pipeline";
