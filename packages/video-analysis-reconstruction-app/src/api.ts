import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-reconstruction-wasm";
...
export const wrappedLibrary = "video-analysis-reconstruction";
