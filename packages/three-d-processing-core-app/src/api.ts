import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/three-d-processing-core-wasm";
...
export const wrappedLibrary = "three-d-processing-core";
