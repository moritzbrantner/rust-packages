import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/graph-analysis-core-wasm";
...
export const wrappedLibrary = "graph-analysis-core";
