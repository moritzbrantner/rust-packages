import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-dataset-wasm";
...
export const wrappedLibrary = "video-analysis-dataset";
