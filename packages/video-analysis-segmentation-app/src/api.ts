import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-segmentation-wasm";
...
export const wrappedLibrary = "video-analysis-segmentation";
