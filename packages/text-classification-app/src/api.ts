import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/text-classification-wasm";
...
export const wrappedLibrary = "text-classification";
