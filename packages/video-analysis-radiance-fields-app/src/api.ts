import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-radiance-fields-wasm";
...
export const wrappedLibrary = "video-analysis-radiance-fields";
