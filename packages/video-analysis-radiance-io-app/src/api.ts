import { init, packageSurface, runOperation as runWasmOperation } from "@moritzbrantner/video-analysis-radiance-io-wasm";
...
export const wrappedLibrary = "video-analysis-radiance-io";
